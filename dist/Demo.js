...
class Demo extends s {
    ...
    render() {
        return $`${this.color} <input type="color" .value="${this.color}" @input="${this.changeColorHandler}" id="colorPicker"><credit-card id="credit-card" title="title" .color="${this.color}"></credit-card>`
    }
